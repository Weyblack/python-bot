...
BOT_TOKEN = "6823549759:AAHyHsi0fhOgd0TpWOOvf6NuQ0rhQHoZt8E"
PAYMENT_CHANNEL = "@asupanaselole" #add payment channel here including the '@' sign
OWNER_ID = 1388857058 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@asupanaselole"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
